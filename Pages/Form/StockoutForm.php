...
if (isset($_POST['StockOut'])) {
    ...
    $remaining_price_total = $remaining_quantity * $productprice;
    ...
    if ($run) {
        ...
        $updateQuery = "UPDATE stockin SET ProductQuantity = $remaining_quantity,TotalPrice=$remaining_price_total WHERE ProductId = $product_id";
                ...
                <section style="margin-bottom: 200px;">
                    <form action="#" method="post" style="margin-bottom: 15%;">
                        ...
                        <input type="text" placeholder="Name of product" name="product"
                            value="<?php echo $products['ProductName'] ?>"><br><br>
                        ...
                        <button class="StockOut"> <a href="../StockOut.php"
